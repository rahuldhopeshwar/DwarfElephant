...
DwarfElephantEIMFKernelsAction::act()
{
  ...
  const DwarfElephantInitializeRBSystemSteadyState & _initialize_rb_system = _problem -> getUserObject<DwarfElephantInitializeRBSystemSteadyState>("initializeRBSystem");
