  ...
  *  2. The problem contains one load vectors (F1) and one output (O1).
  *
  ...
  */
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST6F1O1M3TRANSIENT_H
#define DWARFELEPHANTRBSTRUCTUREST6F1O1M3TRANSIENT_H
...
struct DwarfElephantRBT6F1O1M3TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT6F1O1M3TransientExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST6F1O1M3Transient_H
