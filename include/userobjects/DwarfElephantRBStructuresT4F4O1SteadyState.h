  ...
  *  2. The problem contains five load vector (F5) and one output (O1).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST4F4O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST4F4O1STEADYSTATE_H
...
struct DwarfElephantRBT4F4O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT4F4O1SteadyStateExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST4F4O1STEADYSTATE_H
