...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTURESP1T6EQUALF1O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTURESP1T6EQUALF1O1STEADYSTATE_H
...
#include "DwarfElephantRBStructuresA5ThetaEqualMuP1.h"
...
struct DwarfElephantRBP1T6EqualF1O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBP1T6EqualF1O1SteadyStateExpansion()
  {
  ...
  DwarfElephantThetaA5 _theta_a_5;
  RBTheta _rb_theta;         // Default RBTheta object, simply returns one.
};

///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTURESP1T6EQUALF1O1STEADYSTATE_H
