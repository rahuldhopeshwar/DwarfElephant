  ...
  *  1. The number of thetas is equal to nine (T9).
  *  2. The problem contains two load vectors (F2) and 80 outputs (O80).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST9F10O80STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST9F10O80STEADYSTATE_H
...
struct DwarfElephantRBT9F10O80SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT9F10O80SteadyStateExpansion()
  {
