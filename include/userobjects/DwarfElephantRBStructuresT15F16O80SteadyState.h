...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to 15 (T15). 2. The problem contains 16 load vectors (F16) and 80 outputs (O80).
