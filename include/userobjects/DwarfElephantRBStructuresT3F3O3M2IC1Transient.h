...
///The structures are defined for an parabolic PDE with the following restrictions: 1. The number of thetas is equal to three (T3). 2. The problem contains three load vectors (F3) and one output (O1).
/**
