...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to four (T4). 2. The problem contains one load vector (F1) and one output (O1).
