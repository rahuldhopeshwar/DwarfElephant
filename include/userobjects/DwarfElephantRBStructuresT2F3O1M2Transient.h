  ...
  */
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST2F3O1M2TRANSIENT_H
#define DWARFELEPHANTRBSTRUCTUREST2F3O1M2TRANSIENT_H
...
///The structures are defined for an parabolic PDE with the following restrictions: 1. The number of thetas is equal to four (T4). 2. The problem contains three load vectors (F3) and one output (O1).
/**
...
struct DwarfElephantRBT2F3O1M2TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT2F3O1M2TransientExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST2F3O1M2Transient_H
