  ...
  *  2. The problem contains one load vector (F1) and three outputs (O3).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST3F1O3STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST3F1O3STEADYSTATE_H
...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to three (T3). 2. The problem contains one load vector (F1) and three outputs (O3).
/**
...
struct DwarfElephantRBT3F1O3SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3F1O3SteadyStateExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST3F1O3STEADYSTATE_H
