  ...
  *  2. The problem contains nine load vectors (F9) and one output (O1).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST8F9O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST8F9O1STEADYSTATE_H
...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to eight (T8). 2. The problem contains nine load vectors (F9) and one output (O1).
/**
...
struct DwarfElephantRBT8F9O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT8F9O1SteadyStateExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST8F9O1STEADYSTATE_H
