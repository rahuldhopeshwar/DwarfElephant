  ...
  *     (Equal).
  *  4. The problem contains one load vector (F1) and three outputs (O3).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTURESP1T3EQUALF1O3STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTURESP1T3EQUALF1O3STEADYSTATE_H
...
struct DwarfElephantRBP1T3EqualF1O3SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBP1T3EqualF1O3SteadyStateExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTURESP1T3EQUALF1O3STEADYSTATE_H
