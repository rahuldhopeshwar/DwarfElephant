...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBCLASSESASSEMBLE_H
#define DWARFELEPHANTRBCLASSESASSEMBLE_H
...
class DwarfElephantRBConstructionAssemble : public RBConstruction
{
...
public:
  ...
  // Constructor
  DwarfElephantRBConstructionAssemble (EquationSystems & es,
  ...
  // Destructor
  virtual ~DwarfElephantRBConstructionAssemble () { }

  // Type of the system
  typedef DwarfElephantRBConstructionAssemble _sys_type;
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBCLASSESASSEMBLE_H
