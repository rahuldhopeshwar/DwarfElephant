  ...
  *  2. The problem contains three load vectors (F3) and ten outputs (O10).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST3F3O10STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST3F3O10STEADYSTATE_H
...
#include "DwarfElephantRBStructuresA2ThetaEqualMu2TimesMu0.h"
...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to three (T3). 2. The problem contains three load vectors (F3) and ten outputs (O10).
/**
...
struct DwarfElephantRBT3F3O10SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3F3O10SteadyStateExpansion()
  {
  ...
  DwarfElephantThetaA2EqualMu2TimesMu0 _theta_a_4;
  RBTheta _rb_theta;         // Default RBTheta object, simply returns one.
};

///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST3F3O10STEADYSTATE_H
