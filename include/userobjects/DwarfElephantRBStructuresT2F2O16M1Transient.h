  ...
  *  1. The number of thetas is equal to four (T2).
  *  2. The problem contains two load vectors (F2) and 16 outputs (O16).
  *
  ...
  */
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST2F2O16M1TRANSIENT_H
#define DWARFELEPHANTRBSTRUCTUREST2F2O16M1TRANSIENT_H
...
///The structures are defined for an parabolic PDE with the following restrictions: 1. The number of thetas is equal to four (T4). 2. The problem contains two load vectors (F2) and one output (O1).
/**
...
struct DwarfElephantRBT2F2O16M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT2F2O16M1TransientExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST2F2O16M1Transient_H
