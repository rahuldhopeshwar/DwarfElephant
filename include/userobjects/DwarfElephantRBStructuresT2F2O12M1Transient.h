  ...
  *  2. The problem contains two load vectors (F2) and 12 outputs (O12).
  *
  ...
  */
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST2F2O12M1TRANSIENT_H
#define DWARFELEPHANTRBSTRUCTUREST2F2O12M1TRANSIENT_H
...
struct DwarfElephantRBT2F2O12M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT2F2O12M1TransientExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST2F2O12M1Transient_H
