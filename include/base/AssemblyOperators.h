#ifndef ASSEMBLYOPERATORS_H
#define ASSEMBLYOPERATORS_H
...
struct ThetaA0libmesh : RBTheta { virtual Number evaluate(const RBParameters & mu) { return mu.get_value("mu_0"); } };
struct ThetaA1libmesh : RBTheta { virtual Number evaluate(const RBParameters & mu) { return mu.get_value("mu_1"); } };
struct ThetaA2libmesh : RBTheta { virtual Number evaluate(const RBParameters & mu) { return mu.get_value("mu_2"); } };
...
struct CDRBThetaExpansion : RBThetaExpansion
{
  ...
  ThetaA0libmesh theta_a_0;
  ThetaA1libmesh theta_a_1;
  ThetaA2libmesh theta_a_2;
